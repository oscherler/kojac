...
public class Sellmeier1Parameters extends Parameter
{
	...
	public Sellmeier1Parameters( double k1, double l1, double k2, double l2, double k3, double l3 )
	{
		super();
		this.k1 = k1;
		this.l1 = l1;
	...
	public Sellmeier1Parameters( double[] n ) throws WrongArraySizeException
	{
		super();
		SetArray( n );
	}
